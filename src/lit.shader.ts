import { shader, vec3, vec4, normalize, dot, max, mix, smoothstep, pow, step } from 'brometal';
...
export const Lit = shader({
  ...
  uniforms: { uVp: 'mat4', uModel: 'mat4', uLight: 'vec3', uSky: 'vec3' },
  ...
  fragment({ uLight, uSky }, { vN, vC, vD }) {
    ...
    return vec4(mix(lit, uSky, fog), 1);
  },
});
